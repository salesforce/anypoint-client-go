...
// checks if the UpstreamPatchBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpstreamPatchBody{}
...
func (o UpstreamPatchBody) ToMap() (map[string]interface{}, error) {
