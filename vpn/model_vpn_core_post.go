...
// checks if the VpnCorePost type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VpnCorePost{}
...
func (o VpnCorePost) ToMap() (map[string]interface{}, error) {
