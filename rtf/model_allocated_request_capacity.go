...
// checks if the AllocatedRequestCapacity type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AllocatedRequestCapacity{}

// AllocatedRequestCapacity struct for AllocatedRequestCapacity
...
func (o AllocatedRequestCapacity) MarshalJSON() ([]byte, error) {
...
func (o AllocatedRequestCapacity) ToMap() (map[string]interface{}, error) {
...
type NullableAllocatedRequestCapacity struct {
	value *AllocatedRequestCapacity
	isSet bool
}

func (v NullableAllocatedRequestCapacity) Get() *AllocatedRequestCapacity {
	return v.value
}

func (v *NullableAllocatedRequestCapacity) Set(val *AllocatedRequestCapacity) {
	v.value = val
	v.isSet = true
}

func (v NullableAllocatedRequestCapacity) IsSet() bool {
	return v.isSet
}

func (v *NullableAllocatedRequestCapacity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAllocatedRequestCapacity(val *AllocatedRequestCapacity) *NullableAllocatedRequestCapacity {
	return &NullableAllocatedRequestCapacity{value: val, isSet: true}
}

func (v NullableAllocatedRequestCapacity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAllocatedRequestCapacity) UnmarshalJSON(src []byte) error {
	v.isSet = true
