...
type ErrorsResponse struct {
	Errors *[]ErrorsResponseErrors `json:"errors,omitempty"`
}
...
// SetErrors gets a reference to the given []ErrorsResponseErrors and assigns it to the Errors field.
