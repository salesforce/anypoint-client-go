...
type _OpenIDProviderDynamicPostBody OpenIDProviderDynamicPostBody
...
func (o *OpenIDProviderDynamicPostBody) UnmarshalJSON(data []byte) (err error) {
	...
	varOpenIDProviderDynamicPostBody := _OpenIDProviderDynamicPostBody{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOpenIDProviderDynamicPostBody)

	if err != nil {
		return err
	}

	*o = OpenIDProviderDynamicPostBody(varOpenIDProviderDynamicPostBody)
