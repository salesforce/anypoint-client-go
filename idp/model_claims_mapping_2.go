...
// checks if the ClaimsMapping2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ClaimsMapping2{}
...
func (o ClaimsMapping2) ToMap() (map[string]interface{}, error) {
