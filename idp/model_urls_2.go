...
// checks if the Urls2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Urls2{}
...
func (o Urls2) ToMap() (map[string]interface{}, error) {
