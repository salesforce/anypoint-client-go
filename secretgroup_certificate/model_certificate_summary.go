...
// checks if the CertificateSummary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateSummary{}

// CertificateSummary struct for CertificateSummary
...
func (o CertificateSummary) MarshalJSON() ([]byte, error) {
...
func (o CertificateSummary) ToMap() (map[string]interface{}, error) {
...
type NullableCertificateSummary struct {
	value *CertificateSummary
	isSet bool
}

func (v NullableCertificateSummary) Get() *CertificateSummary {
	return v.value
}

func (v *NullableCertificateSummary) Set(val *CertificateSummary) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateSummary) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateSummary) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateSummary(val *CertificateSummary) *NullableCertificateSummary {
	return &NullableCertificateSummary{value: val, isSet: true}
}

func (v NullableCertificateSummary) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateSummary) UnmarshalJSON(src []byte) error {
	v.isSet = true
