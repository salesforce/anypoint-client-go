...
------------ | ------------- | ------------- | -------------
**Errors** | Pointer to [**[]ErrorsInner**](ErrorsInner.md) |  | [optional] 
...
`func (o *ErrorsResponse) GetErrors() []ErrorsInner`

GetErrors returns the Errors field if non-nil, zero value otherwise.

### GetErrorsOk

`func (o *ErrorsResponse) GetErrorsOk() (*[]ErrorsInner, bool)`
...
`func (o *ErrorsResponse) SetErrors(v []ErrorsInner)`
