...
// checks if the TeamGroupMapping type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TeamGroupMapping{}

// TeamGroupMapping struct for TeamGroupMapping
...
func (o TeamGroupMapping) MarshalJSON() ([]byte, error) {
...
func (o TeamGroupMapping) ToMap() (map[string]interface{}, error) {
...
type NullableTeamGroupMapping struct {
	value *TeamGroupMapping
	isSet bool
}

func (v NullableTeamGroupMapping) Get() *TeamGroupMapping {
	return v.value
}

func (v *NullableTeamGroupMapping) Set(val *TeamGroupMapping) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamGroupMapping) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamGroupMapping) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamGroupMapping(val *TeamGroupMapping) *NullableTeamGroupMapping {
	return &NullableTeamGroupMapping{value: val, isSet: true}
}

func (v NullableTeamGroupMapping) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamGroupMapping) UnmarshalJSON(src []byte) error {
	v.isSet = true
