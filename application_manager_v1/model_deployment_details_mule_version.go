...
// checks if the DeploymentDetailsMuleVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentDetailsMuleVersion{}

// DeploymentDetailsMuleVersion Details of the current Mule runtime version in use.
type DeploymentDetailsMuleVersion struct {
...
func NewDeploymentDetailsMuleVersion() *DeploymentDetailsMuleVersion {
	this := DeploymentDetailsMuleVersion{}
	return &this
}
...
func (o DeploymentDetailsMuleVersion) MarshalJSON() ([]byte, error) {
...
func (o DeploymentDetailsMuleVersion) ToMap() (map[string]interface{}, error) {
...
type NullableDeploymentDetailsMuleVersion struct {
	value *DeploymentDetailsMuleVersion
	isSet bool
}

func (v NullableDeploymentDetailsMuleVersion) Get() *DeploymentDetailsMuleVersion {
	return v.value
}

func (v *NullableDeploymentDetailsMuleVersion) Set(val *DeploymentDetailsMuleVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentDetailsMuleVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentDetailsMuleVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentDetailsMuleVersion(val *DeploymentDetailsMuleVersion) *NullableDeploymentDetailsMuleVersion {
	return &NullableDeploymentDetailsMuleVersion{value: val, isSet: true}
}

func (v NullableDeploymentDetailsMuleVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentDetailsMuleVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
