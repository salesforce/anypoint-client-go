...
// checks if the DeploymentDetailsWorkersType type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DeploymentDetailsWorkersType{}

// DeploymentDetailsWorkersType Details about the worker type including size and resource allocations.
type DeploymentDetailsWorkersType struct {
...
func NewDeploymentDetailsWorkersType() *DeploymentDetailsWorkersType {
	this := DeploymentDetailsWorkersType{}
	return &this
}
...
func (o DeploymentDetailsWorkersType) MarshalJSON() ([]byte, error) {
...
func (o DeploymentDetailsWorkersType) ToMap() (map[string]interface{}, error) {
...
type NullableDeploymentDetailsWorkersType struct {
	value *DeploymentDetailsWorkersType
	isSet bool
}

func (v NullableDeploymentDetailsWorkersType) Get() *DeploymentDetailsWorkersType {
	return v.value
}

func (v *NullableDeploymentDetailsWorkersType) Set(val *DeploymentDetailsWorkersType) {
	v.value = val
	v.isSet = true
}

func (v NullableDeploymentDetailsWorkersType) IsSet() bool {
	return v.isSet
}

func (v *NullableDeploymentDetailsWorkersType) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDeploymentDetailsWorkersType(val *DeploymentDetailsWorkersType) *NullableDeploymentDetailsWorkersType {
	return &NullableDeploymentDetailsWorkersType{value: val, isSet: true}
}

func (v NullableDeploymentDetailsWorkersType) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDeploymentDetailsWorkersType) UnmarshalJSON(src []byte) error {
	v.isSet = true
