...
// checks if the VCoresDesign type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &VCoresDesign{}
...
func (o VCoresDesign) ToMap() (map[string]interface{}, error) {
