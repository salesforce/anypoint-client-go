...
// checks if the ObjectStoreRequestUnits type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ObjectStoreRequestUnits{}
...
func (o ObjectStoreRequestUnits) ToMap() (map[string]interface{}, error) {
