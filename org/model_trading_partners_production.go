...
// checks if the TradingPartnersProduction type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TradingPartnersProduction{}
...
func (o TradingPartnersProduction) ToMap() (map[string]interface{}, error) {
