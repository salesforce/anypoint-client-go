...
// checks if the MqMessages type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MqMessages{}
...
func (o MqMessages) ToMap() (map[string]interface{}, error) {
