...
// checks if the TheDesignCenterSchema type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TheDesignCenterSchema{}
...
func (o TheDesignCenterSchema) ToMap() (map[string]interface{}, error) {
