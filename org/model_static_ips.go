...
// checks if the StaticIps type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &StaticIps{}
...
func (o StaticIps) ToMap() (map[string]interface{}, error) {
