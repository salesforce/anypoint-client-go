...
// checks if the MqRequests type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &MqRequests{}
...
func (o MqRequests) ToMap() (map[string]interface{}, error) {
