...
type DefaultApiApiOrganizationsOrgIdUsersDeleteRequest struct {
...
func (r DefaultApiApiOrganizationsOrgIdUsersDeleteRequest) RequestBody(requestBody []map[string]interface{}) DefaultApiApiOrganizationsOrgIdUsersDeleteRequest {
	r.requestBody = &requestBody
	return r
}

func (r DefaultApiApiOrganizationsOrgIdUsersDeleteRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.OrganizationsOrgIdUsersDeleteExecute(r)
}

/*
 * OrganizationsOrgIdUsersDelete Method for OrganizationsOrgIdUsersDelete
 * Delete one or more users
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId The ID of the organization in GUID format
 * @return DefaultApiApiOrganizationsOrgIdUsersDeleteRequest
 */
func (a *DefaultApiService) OrganizationsOrgIdUsersDelete(ctx _context.Context, orgId string) DefaultApiApiOrganizationsOrgIdUsersDeleteRequest {
	return DefaultApiApiOrganizationsOrgIdUsersDeleteRequest{
		ApiService: a,
		ctx: ctx,
		orgId: orgId,
 ...
 */
func (a *DefaultApiService) OrganizationsOrgIdUsersDeleteExecute(r DefaultApiApiOrganizationsOrgIdUsersDeleteRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.OrganizationsOrgIdUsersDelete")
	if err != nil {
...
type DefaultApiApiOrganizationsOrgIdUsersPostRequest struct {
	...
	ApiService *DefaultApiService
	orgId string
	usersPostBody *UsersPostBody
}

func (r DefaultApiApiOrganizationsOrgIdUsersPostRequest) UsersPostBody(usersPostBody UsersPostBody) DefaultApiApiOrganizationsOrgIdUsersPostRequest {
	r.usersPostBody = &usersPostBody
	return r
}
...
func (a *DefaultApiService) OrganizationsOrgIdUsersPostExecute(r DefaultApiApiOrganizationsOrgIdUsersPostRequest) (User, *_nethttp.Response, error) {
	...
	// body params
	localVarPostBody = r.usersPostBody
	req, err := a.client.prepareRequest(r.ctx, localVarPath, localVarHTTPMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFormFileName, localVarFileName, localVarFileBytes)
	if err != nil {
		return localVarReturnValue, nil, err
	}
...
type DefaultApiApiOrganizationsOrgIdUsersPutRequest struct {
	ctx _context.Context
	ApiService *DefaultApiService
	orgId string
	requestBody *[]map[string]interface{}
...
func (r DefaultApiApiOrganizationsOrgIdUsersPutRequest) RequestBody(requestBody []map[string]interface{}) DefaultApiApiOrganizationsOrgIdUsersPutRequest {
	r.requestBody = &requestBody
	return r
}

func (r DefaultApiApiOrganizationsOrgIdUsersPutRequest) Execute() (*_nethttp.Response, error) {
	return r.ApiService.OrganizationsOrgIdUsersPutExecute(r)
}

/*
 * OrganizationsOrgIdUsersPut Method for OrganizationsOrgIdUsersPut
 * Update an User
 * @param ctx _context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param orgId The ID of the organization in GUID format
 * @return DefaultApiApiOrganizationsOrgIdUsersPutRequest
 */
func (a *DefaultApiService) OrganizationsOrgIdUsersPut(ctx _context.Context, orgId string) DefaultApiApiOrganizationsOrgIdUsersPutRequest {
	return DefaultApiApiOrganizationsOrgIdUsersPutRequest{
		ApiService: a,
		ctx: ctx,
		orgId: orgId,
 ...
 * Execute executes the request
 */
func (a *DefaultApiService) OrganizationsOrgIdUsersPutExecute(r DefaultApiApiOrganizationsOrgIdUsersPutRequest) (*_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultApiService.OrganizationsOrgIdUsersPut")
	if err != nil {
		return nil, GenericOpenAPIError{error: err.Error()}
	}
