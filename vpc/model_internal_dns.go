...
func (o *InternalDns) UnmarshalJSON(data []byte) (err error) {
	...
	varInternalDns := _InternalDns{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varInternalDns)

	if err != nil {
		return err
	}

	*o = InternalDns(varInternalDns)
