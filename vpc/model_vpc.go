...
type Vpc struct {
	...
	FirewallRules *[]VpcFirewallRules `json:"firewallRules,omitempty"`
	// The vpc Id
...
// SetFirewallRules gets a reference to the given []VpcFirewallRules and assigns it to the FirewallRules field.
