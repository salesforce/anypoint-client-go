...
// checks if the RolegroupPutBody type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RolegroupPutBody{}
...
func (o RolegroupPutBody) ToMap() (map[string]interface{}, error) {
