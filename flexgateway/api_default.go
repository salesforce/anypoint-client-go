...
type DefaultApiApiGetFlexGatewayRegistrationTokenRequest struct {
...
func (r DefaultApiApiGetFlexGatewayRegistrationTokenRequest) Execute() (FlexGatewayRegistrationToken, *_nethttp.Response, error) {
 ...
 * @return DefaultApiApiGetFlexGatewayRegistrationTokenRequest
 */
func (a *DefaultApiService) GetFlexGatewayRegistrationToken(ctx _context.Context, orgId string, envId string) DefaultApiApiGetFlexGatewayRegistrationTokenRequest {
	return DefaultApiApiGetFlexGatewayRegistrationTokenRequest{
		ApiService: a,
		ctx: ctx,
		orgId: orgId,
 ...
 */
func (a *DefaultApiService) GetFlexGatewayRegistrationTokenExecute(r DefaultApiApiGetFlexGatewayRegistrationTokenRequest) (FlexGatewayRegistrationToken, *_nethttp.Response, error) {
	var (
