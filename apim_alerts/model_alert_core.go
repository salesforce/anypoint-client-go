...
func (o *AlertCore) UnmarshalJSON(data []byte) (err error) {
	...
	varAlertCore := _AlertCore{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAlertCore)

	if err != nil {
		return err
	}

	*o = AlertCore(varAlertCore)
